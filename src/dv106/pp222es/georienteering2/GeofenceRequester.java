...
import com.google.android.gms.common.GooglePlayServicesClient; //NOTE: Deprecated (but works for API 19)
import com.google.android.gms.common.GooglePlayServicesClient.ConnectionCallbacks; //NOTE: Deprecated (but works for API 19)
import com.google.android.gms.common.GooglePlayServicesClient.OnConnectionFailedListener; //NOTE: Deprecated (but works for API 19)
import com.google.android.gms.location.Geofence;
import com.google.android.gms.location.LocationClient; //NOTE: Deprecated (but works for API 19)
//import com.google.android.gms.location.LocationRequest;
import com.google.android.gms.location.LocationStatusCodes; //NOTE: Deprecated (but works for API 19)
import com.google.android.gms.location.LocationClient.OnAddGeofencesResultListener; //NOTE: Deprecated (but works for API 19)
 ...
 *
 * REF:
 * This class is an almost identical copy from Googles Developer site at:
 * http://developer.android.com/training/location/geofencing.html
 * 
 * TODO:
 * 1. onConnectionFailed handling is out of date.
 * 2. Only works with opened app!?
 *    http://stackoverflow.com/questions/19434999/android-geofence-only-works-with-opened-app
 *    
 * UPDATES:
 * 1. createRequestPendingIntent is using a Broadcast Receiver instead of IntentService 
 *    to detect a geofence transition event.  
 *    -> This update did NOT fix the geofence trigger problem.
 */
public class GeofenceRequester
	...
	private static final String LOG = "GeofenceRequester";
    ...
    public void addGeofences(List<Geofence> geofences) throws UnsupportedOperationException {
        ...
        // If a request is in progress
        	...
        	Log.w(LOG, "A request is already in progress");
     ...
     * 
     * NOTE: Is there a bug in here?
     * See http://stackoverflow.com/questions/22905144/not-seeing-geofence-transitions-in-googles-tutorial-on-geofencing-any-working
     * 
     */
    ...
    private void continueAddGeofences() {
        ...
        Log.i(LOG, "Add request was sent to Location Client");
    }
   
    // From http://stackoverflow.com/questions/22905144/not-seeing-geofence-transitions-in-googles-tutorial-on-geofencing-any-working
    // TESTED this briefly 20141129:
    // It led to this in log:
    // 11-29 10:40:45.054: E/GeofenceDetectorService(2711): Geofence transition error. Invalid type -1 in geofences
    // but I also still noticed that geofences were not (always) triggered.
 /*   
    private void continueAddGeofences() {
        ...
        Log.i(LOG, "Add request was sent to Location Client. Now also trying to make a location update request...");
        
        //TODO: What does this code really do... is it a kind of workaround?
        try {
...
*/
    ...
    public void onConnected(Bundle arg0) {
        // Log the connection
        Log.d(LOG, mActivity.getString(R.string.connected));
    ...
    public void onDisconnected() {
        ...
        Log.d(LOG, mActivity.getString(R.string.disconnected));
 ...
 /*   
    private PendingIntent createRequestPendingIntent() {
        ...
        if (null != mGeofencePendingIntent) {
        	...
        	Log.i(LOG, "PendingIntent already exists, reusing the existing intent from createRequestPendingIntent()");
        ...
        // If no PendingIntent exists
        	...
        	Log.i(LOG, "Creating new PendingIntent");

            // Create an Intent pointing to the IntentService
            Intent intent = new Intent(mActivity, GeofenceDetectorService.class);
            /*
...
*/
    private PendingIntent createRequestPendingIntent() {
        ...
        // If no PendingIntent exists
            ...
            // Create an action Intent for the Broadcast Receiver
            Intent intent = new Intent("dv106.pp222es.georienteering.ACTION_RECEIVE_GEOFENCE_TRANSITION");

            /*
             * Return a PendingIntent to start the Broadcast Receiver.
             * Always create a PendingIntent sent to Location Services
             * with FLAG_UPDATE_CURRENT, so that sending the PendingIntent
             * again updates the original. Otherwise, Location Services
             * can't match the PendingIntent to requests made with it.
