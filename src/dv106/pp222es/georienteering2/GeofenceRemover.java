...
import com.google.android.gms.location.LocationClient.OnRemoveGeofencesResultListener; //NOTE: Deprecated (but works for API 19)
 ...
 *    
 * UPDATES:
 * 1. Bug fix: Setting mInProgress = true when a new request is made in both removeGeofencesById and removeGeofencesByIntent 
 */
public class GeofenceRemover implements
	...
	private static final String LOG = "GeofenceRemover";
    ...
    public void removeGeofencesById(List<String> geofenceIds) throws
        ...
        // Set the request type, store the List, and request a location client connection.
            ...
            if (!mInProgress) {              	
            	...
            	mInProgress = true; // PREP ADDED 20141129            	
            	
            	// Set the request type, store the List.
            ...
            // If a removal request is in progress, throw an exception
            	...
            	Log.w(LOG, "A removal request is already in progress");
    ...
    /**
     * Remove the geofences associated with a PendingIntent. The PendingIntent is the one used
    ...
    private void continueRemoveGeofences() {
        ...
        Log.i(LOG, "Remove request was sent to Location Client");
    }
    ...
    public void onConnected(Bundle arg0) {
        ...
        Log.d(LOG, mContext.getString(R.string.connected));
    ...
    public void onDisconnected() {
        ...
        Log.d(LOG, mContext.getString(R.string.disconnected));
